...
const AdminDashboard = ({ onLogout }) => {
  const [activeTab, setActiveTab] = useState('employees'); // 'employees', 'approvals', 'history', 'add-employee'
  ...
  const handleAddEmployee = async (e) => {
    ...
    try {
      ...
      setActiveTab('employees'); // Switch back to list
    } catch (err) {
      ...
      <div className="card p-4 shadow-sm">
        ...
        {activeTab === 'add-employee' && (
          <div style={{ maxWidth: '500px', margin: '0 auto' }}>
            <h4 className="text-center mb-4">Register New Employee</h4>
            <form onSubmit={handleAddEmployee}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" required className="form-control" placeholder="e.g. Welcome@2025" 
